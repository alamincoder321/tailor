...
<nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
    <div class="sb-sidenav-menu">
        <div class="nav">
            ...
            @endif
            @if(in_array("orderEntry", $access) || in_array("orderList", $access))
            ...
            @endif
            @if(in_array("clothingEntry", $access) || in_array("clothingList", $access))
            ...
            @endif
            @if(in_array("customerPayment", $access) || in_array("tailorPayment", $access) || in_array("expenseEntry", $access))
            ...
            @endif
            @if(in_array("customerLedger", $access) || in_array("tailorLedger", $access))
            ...
            @endif
            @if(in_array("employeeEntry", $access) || in_array("employeeList", $access))
            ...
            @endif
            @if(in_array("customerSMS", $access))
