...
@endsection
@section("bread_crum", "User Profile")
@section('content')
    <!-- Column -->
    <div class="row">
                            ...
                            <div class="row">
                                <div class="col-12 col-lg-4">
                                    <div class="form-group ImageBackground">
                                        <img src="{{ asset($data->image != null ? $data->image : 'noImage.png') }}" class="imageShow" />
                                        <label for="image">Image</label>
                                        <input type="file" id="image" class="form-control shadow-none"
                                            onchange="imageUpdate(event)" />
                                    </div>
...
@push('js')
    <script>
        ...
        function imageUpdate(event) {
            ...
            $.ajax({
                url: location.origin + "/user-profileimage",
                method: "POST",
                data: formdata,
                contentType: false,
                processData: false,
